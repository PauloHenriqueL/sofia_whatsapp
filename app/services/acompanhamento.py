...
status da 1ª consulta no Hamilton e monta duas listas pro painel da Thainá:
...
async def montar_acompanhamento(
    ...
    """Monta as listas de espera (Demanda 3) e cobrança (Demanda 4)."""
    ...
    return {"espera": espera, "cobranca": cobranca, "erro": erro, "meta_dias": META_DIAS}


async def marcar_cobranca_resolvida(db: AsyncSession, conversa: Conversa) -> None:
    """Marca a cobrança como resolvida: o paciente sai da lista de cobrança."""
